...
4. Execute Actions:
   ...
   B. For Straightforward Changes:
      ...
      ? `- After committing, a PR is created using the \`katana git pull_request --target="${eventData.defaultBranch}" --source="<branch-name>" --title="pull request title" --body="pull request message" [screenshot-filepath1] [screenshot-filepath2] ...\` command.
          IMPORTANT: Backquotes and double quotes must be escaped with a backslash when used in \`title\` or \`body\`. Also, you need to escape exclamation marks\`!\`
          Example: katana git pull_request --target="${eventData.defaultBranch}" --source="feature/fix_any_bugs" --title="feat: add new feature" --body="# Summary\\n\\n- This is a new feature\\n- \\\`Tags\\\` are escaped like this.\\n\\n- \\"Comment\\" are escaped like this.\\n\\n# Images\\n\\n- The image will be attached as follows.\\n\\n\\![screenshot1.png](https://github.com/<org-name>/<repo-name>/blob/<branch-name>/documents/test/ci/pages/screenshots/screenshot1.png)" documents/test/ci/pages/screenshots/screenshot1.png documents/test/ci/pages/screenshots/screenshot2.png`
          : `- After committing, use \`katana git pull_request --target="${eventData.defaultBranch}" --source="<branch-name>" --title="pull request title" --body="pull request message" [screenshot-filepath1] [screenshot-filepath2] ...\` command to add a comment to the PR.
          IMPORTANT: Backquotes and double quotes must be escaped with a backslash when used in \`title\` or \`body\`. Also, you need to escape exclamation marks\`!\`
          Example: katana git pull_request --target="${eventData.defaultBranch}" --source="feature/fix_any_bugs" --title="feat: add new feature" --body="# Summary\\n\\n- This is a new feature\\n- \\\`Tags\\\` are escaped like this.\\n\\n- \\"Comment\\" are escaped like this.\\n\\n# Images\\n\\n- The image will be attached as follows.\\n\\n\\![screenshot1.png](https://github.com/<org-name>/<repo-name>/blob/<branch-name>/documents/test/ci/pages/screenshots/screenshot1.png)" documents/test/ci/pages/screenshots/screenshot1.png documents/test/ci/pages/screenshots/screenshot2.png`
      }`
      }
...
- Do not use the \`git\` command. Instead, use \`katana git commit --message="commit message" [file-path1] [file-path2] ...\` for making commits (works for both new and existing files, single or multiple). Use \`katana git remove --message="commit message" [file-path1] [file-path2] ...\` for deleting files (supports deleting single or multiple files atomically), or \`katana git remove --message="commit message" [file-path1] [file-path2] ...\` for deleting a single file. Edit files locally, and the tool will read the content from the same path on disk. Use \`katana git pull_request --target="${eventData.defaultBranch}" --source="<branch-name>" --title="pull request title" --body="pull request message" [screenshot-filepath1] [screenshot-filepath2] ...\` for creating a pull request.
  Tool usage examples:
  ...
  - \`katana git pull_request --target="${eventData.defaultBranch}" --source="<branch-name>" --title="pull request title" --body="pull request message" documents/test/ci/pages/screenshot1.png documents/test/ci/pages/screenshot2.png\`
